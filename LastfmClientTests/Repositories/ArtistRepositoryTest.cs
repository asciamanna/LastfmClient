...
namespace LastfmClientTests.Repositories {
  ...
  public class ArtistRepositoryTest {
    ...
    private static string CreateExpectedUri(string apiKey, string artist) {
      return string.Format(@"http://ws.audioscrobbler.com/2.0/?method=artist.getinfo&api_key={0}&artist={1}",
        apiKey, artist);
    }
  }
}
