...
namespace LastfmClientTests {
  ...
  public class LastfmServiceTest {
    ...
    public void Object_Constructed_Without_An_API_Key_Throws_Exception() {
      var exception = Assert.Throws<ArgumentException>(() => new LastfmService(string.Empty, null, null, null, null, null));
    ...
    public void FindRecentTracks_Calls_Rest_Service_Once_For_Each_Page() {
      ...
      var recentTracks = new LastfmService("key", restClient, parser, pageCalculator, null, null).FindRecentTracks("me", 2);
    ...
    public void FindRecentTracks_Only_Takes_Positive_Values_For_Number_Of_Recent_Tracks(int numberOfTracks) {
      var exception = Assert.Throws<ArgumentException>(() => new LastfmService("key", null, null, null, null, null).FindRecentTracks("me", numberOfTracks));
    ...
    public void FindRecentTracks_Returns_Exactly_The_Number_Of_Tracks_Requested_Even_If_Retrieves_More_From_Lastfm() {
      ...
      var recentTracks = new LastfmService("key", restClient, parser, pageCalculator, null, null).FindRecentTracks("me", 1);
    ...
    public void FindTopArtists_Only_Takes_Positive_Values_For_Number_Of_Top_Artists(int numberOfArtists) {
      var exception = Assert.Throws<ArgumentException>(() => new LastfmService("key", null, null, null, null,null).FindTopArtists("me", numberOfArtists));
    ...
    public void FindTopArtists_Calls_Rest_Service_Once_For_Each_Page() {
      ...
      var topArtists = new LastfmService("key", restClient, parser, pageCalculator, null, null).FindTopArtists("me", 2);
    ...
    public void FindTopArtists_Returns_Exactly_The_Number_Of_Tracks_Requested_Even_If_Retrieves_More_From_Lastfm() {
      ...
      var topArtists = new LastfmService("key", restClient, parser, pageCalculator, null, null).FindTopArtists("me", 1);
    ...
    public void FindCurrentlyPlayingFrom_Delegates_To_PageScraper() {
      ...
      var service = new LastfmService("key", null, null, null, pageScraper, null);
